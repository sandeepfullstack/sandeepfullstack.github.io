...
for file in *.mp3; do
  echo "Compressing with VBR: $file"
  ffmpeg -i "$file" -q:a 5 "/data/ytpl/PatanjalisYogaSutras/compressed/$file"
done
...
[Detailed Patanjali Yoga Sutras with Pictures](https://www.youtube.com/watch?v=L1jdEWSEFUo)
[Detailed Patanjali Yoga Sutras with Pictures](https://www.youtube.com/watch?v=L1jdEWSEFUo&list=PLAPrVB8wngPnXpf5OhUqYgE_i6JlhtL8a)

https://www.youtube.com/watch?v=vSaf47zusx4
https://arshabodha.org/teachings/yoga-sutra/

```sh
# show all files and folder size
du -ah . | sort -h
# file and folder at 1 level
du -sh * | sort -h
```